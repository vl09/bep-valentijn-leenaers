...
The susceptibility of a damped harmonic oscillator relates displacement to a harmonic drive. In cyclic frequency $f$, the magnitude of the displacement response near resonance has a Lorentzian lineshape. The full width at half maximum $\Delta f$ satisfies $\Gamma_m = 2\pi\,\Delta f$ when $\Gamma_m$ is expressed in $Hz$, as stated in [](#theory).
